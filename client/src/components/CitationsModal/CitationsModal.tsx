...
const CitationsModal = (props: CitationsModalProps) => {
  ...
  const [getCitedByArticles] = useCitedByArticlesMutation();
  ...
  const [getArticlesCitingCases] = useArticlesCitingCaseMutation();
  const [getReferencesWithCase] = useReferencesWithCaseMutation();

  // Article Citations count queries
  const [getCitedbyArticlesCount] = useLazyCitedByArticlesCountQuery();
  ...
  const [getArticlesCitingCasesCount] = useLazyArticlesCitingCaseCountQuery();
  ...
  const onModalClose = () => {
    ...
    dispatch(setCitedByArticles([]));
    dispatch(setCitingArticles([]));
